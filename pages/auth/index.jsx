...
const Auth = () => {
  ...
  return (
    <div className="flex flex-col h-screen lg:flex-row items-center w-full">
      {/* twitter logo */}
      <div className="lg:w-[40%] w-full lg:h-screen bg-blue-100  justify-center items-center flex-col gap-4 lg:gap-8  flex  p-3">
        <h1 className="font-bold text-3xl">Join Twitter Today.</h1>
        <Image
          src="https://www.datafeedwatch.com/hubfs/alexander-shatov-k1xf2D7jWUs-unsplash%20%281%29.jpg"
          alt="twitter-logo"
          width="300"
          height="380"
      ...
      {/* auth form */}
      <div className="w-full lg:w-[60%] px-8 py-4">
        {/* Twitter Icon */}
        <Image
