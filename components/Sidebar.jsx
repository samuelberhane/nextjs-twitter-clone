...
const Sidebar = () => {
  return (
    <div className="fixed hidden p-1 sm:inline overflow-y-scroll">
      {/* Twitter Icon */}
      <Image
      ...
      {/* Button */}
      <button className="hidden py-3 my-3 xl:my-5 text-xl text-white bg-blue-500 px-14 rounded-3xl lg:inline">
        Tweet
      </button>
      {/* Mini User Profile */}
